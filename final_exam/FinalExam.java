public class FinalExam {
    public static void main(String[] args) throws Exception {
        ...
        for (int row = 14; row >= 0; row--){
            System.out.print("");
            for (int column = 14; column >= 0; column--){
                if (row == 12 && column == 5 || row == 11 && column == 4
                 || row == 10 && column == 3 || row == 9 && column == 2
                 || row == 8 && column == 1 || row == 7 && column == 0) {
                    System.out.print(array[row][column]);
                }
    }   
  }
        ...
        for (int row = 14; row >= 0; row--){
            System.out.print("");
            for (int column = 14; column >= 0; column--){
                if (row == 0 && column == 4 || row == 1 && column == 3
                 || row == 2 && column == 2 || row == 3 && column == 1
                 || row == 4 && column == 0) {
                    System.out.print(array[row][column]);
        }
    }   
